...
if(isset($_POST['insert_factory'])){
    ...
    if (mysqli_num_rows($check_result) > 0) {
        ...
        $initial_amt = $factory_amount;
        // Prepare the SQL statement
        $stmt = $con->prepare("INSERT INTO factories (factory_name, factory_mobile, factory_address, factory_amount, initial_amt, payment_due) VALUES (?, ?, ?, ?, ?, ?)");
        ...
        // Bind the parameters
        $stmt->bind_param("sssdii", $factory_name, $factory_mobile, $factory_address, $factory_amount, $initial_amt, $payment_due);
